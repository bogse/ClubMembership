...
namespace clubmembership.Controllers
{
    public class AnnouncementController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(list); //trebuie pasata si lista
        }
        ...
        public ActionResult Create(IFormCollection collection)
        {
            try
            {
                ...
                return RedirectToAction("Index"); //pagina unde se redirectioneaza ex: checkout
            }
            catch
            {
                return View("CreateAnnouncement");
        ...
        public ActionResult Edit(Guid id, IFormCollection collection)
        {
            try
            {
                ...
                return RedirectToAction("Index"); //name of index mai trebuie sa faca ceva calc decat hardcoded
            }
            catch
            {
        ...
        public ActionResult Delete(Guid id, IFormCollection collection)
        {
            ...
            {
                return RedirectToAction("Delete", id); //daca nu au nevoie de id se poate da view
            }
        }
    }
}
